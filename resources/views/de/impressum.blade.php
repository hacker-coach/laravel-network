...
@include('snippet.sectionheader', ['title' =>'Impressum'])
...
<section class="three-col-teaser bg-light ">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="black-box">Impressum</h3>
                <p class="lead mb-0">Micha Barthel, Mühlenstr. 136, 28779 Bremen</p>
				  <h3 class="black-box">Haftungsausschluss (Disclaimer)</h3>
