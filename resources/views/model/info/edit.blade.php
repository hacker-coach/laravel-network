                ...
                <div class="card"  style="margin-top:50px;margin-bottom: 50px;">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('infoUpdate',$info->id) }}" enctype="multipart/form-data">
                            ...
                            @include('form.textarea', ['name' =>'message','title'=>__('Nachricht'),'value'=>$info->message,'required'=>'required'])
                            @include('form.textarea', ['name' =>'ps','title'=>__('Problemlöser'),'value'=>$info->ps,'required'=>'required'])
